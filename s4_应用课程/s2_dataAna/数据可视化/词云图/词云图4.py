...
text = open(r'远走高飞3.txt',"r",encoding='utf-8').read()
...
wc = WordCloud(font_path=r"zhongyiheiti.ttf",background_color='white',max_font_size=50,mask=graph)
